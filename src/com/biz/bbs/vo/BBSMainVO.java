...
public class BBSMainVO {
	...
	/*
	 * VO에 매개변수를 받아서 
	 * 맴버변수를 초기화하는 생성자를 선언한다.
	 * 맴버변수, field 생성자
	 */
	public BBSMainVO(String b_date, String b_auth, String b_subject, String b_text) {
		super();
		this.b_date = b_date;
		this.b_auth = b_auth;
	...
	public BBSMainVO(long b_id, String b_date, String b_auth, String b_subject, String b_text) {
		super();
		this.b_id = b_id;
		this.b_date = b_date;
		this.b_auth = b_auth;
